...
img.onload = () => {
  ...
  // Trigger resize after image is fully loaded
  this.onResize()
}
  ...
  // Set width: 90% of viewport width
  this.plane.scale.x = this.viewport.width * 0.4

  // If we know the aspect ratio, calculate height properly
  if (this.imageAspect) {
    this.plane.scale.y = this.plane.scale.x / 2
  } else {
    // fallback temporary height before image loads
