                        ...
                        return (
                            ...
                            >
                                <Image
                                    ...
                                    src={url}
                                    alt="gallery"
                                    className="pointer-events-none rounded-[15px] border-[3px] border-white object-cover transition-transform duration-300 ease-out group-hover:scale-105 w-[200px] h-[100px] w-[160px] md:h-[160px] md:w-[240px]" // <-- Increased height here
                                />
                            </div>
                        );
                     })}
